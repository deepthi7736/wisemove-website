...
(function(){
  ...
  /* ---------------------------------------------------------------------
     ...
     --------------------------------------------------------------------- */
  /* ---------------------------------------------------------------------
     HOW WE MOVE — sticky editorial process. As each step nears the
     center of the viewport, it becomes the active (highlighted) step.
     No scroll-jacking — this only toggles a class; normal scrolling is
     completely unaffected.
     --------------------------------------------------------------------- */
  function initHowWeMove(){
    const steps = document.querySelectorAll('.hwm-step');
